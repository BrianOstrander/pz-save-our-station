...
SWWS_Schedules.stages.interruption = {
	status = {
		"AEBS_StageStatusInterruption_1",
		"AEBS_StageStatusInterruption_2"
	},
	statusColor = { r = 1.0, g = 0.76, b = 0.74 },
	failureChance = 100
}

SWWS_Schedules.stages.interruptionResolved = {
	status = {
		"AEBS_StageStatusInterruptionResolved_1",
		"AEBS_StageStatusInterruptionResolved_2"
	},
	statusColor = { r = 1.0, g = 0.976, b = 0.741 },
	failureChance = 100
}
	...
	-- Non-Fatal (Interruption)
	{
		...
		stages = {
			...
			},
			{
				hoursMinimum = 1,
				hoursMaximum = 2,
				messages = SWWS_Schedules.stages.interruption
			},
			{
				hoursMinimum = 1,
				hoursMaximum = 1,
